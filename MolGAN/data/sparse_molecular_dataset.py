...
if __name__ == '__main__':
    ...
    data = SparseMolecularDataset()
    data.generate("ZINC_250k.smi", validation=0.00021, test=0.00021, filters=lambda x: x.GetNumAtoms() <= 14)  # , filters=lambda x: x.GetNumAtoms() <= 9)
    data.save("ZINC_250.sparsedataset")
